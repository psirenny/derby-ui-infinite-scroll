...
exports._canPageDown = function (e, el, dom, model) {
  return model.get('options.pageSize') === model.get('bottomPage.items').length;
};

exports._canPageUp = function (e, el, dom, model) {
  return model.get('options.pageSize') === model.get('topPage.items').length;
};
...
exports._page = function (e, el, dom, model, dir) {
  switch (dir) {
    case 'down': return this.pageDown(e, el, dom, model);
    case 'up': return this.pageUp(e, el, dom, model);
  }
};
...
exports.init = function (model) {
  var options = {
    ...
    , reverseUp: model.get('reverseup') || true
...
exports.create = function (model, dom) {
  ...
  scope.fn('topItem', scope.at('topPage'), function (topPage) { return topPage.items[0]; });
  ...
  scope.fn('bottomItem', scope.at('bottomPage'), function (bottomPage) { return bottomPage.items[bottomPage.items.length - 1]; });
